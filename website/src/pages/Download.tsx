...
const VARIANTS = [
  { name: "ARM64-v8a", file: "Bill-Reminder-arm64-v8a.apk", size: "38.5 MB", description: "Modern Android phones / most devices" },
  { name: "ARMv7", file: "Bill-Reminder-armeabi-v7a.apk", size: "32.6 MB", description: "Older 32-bit ARM devices" },
  { name: "x86_64", file: "Bill-Reminder-x86_64.apk", size: "39.0 MB", description: "64-bit Intel devices / emulators" },
  { name: "x86", file: "Bill-Reminder-x86.apk", size: "39.5 MB", description: "Older Intel devices / emulators" },
];
